...
from cfg_services.erlang.branch_parsers.CaseParser import CaseParser

class ErlangCfgParser:
    # Multi-clause branching constructs
    BRANCH_NODES = {
        'case_expr',
        'if_expr', 
        'receive_expr',
    ...
    def __init__(self):
        ...
        self.BRANCH_REGISTRY: dict[str, BranchParser] = {
            ...
            #todo implement, then add parsers 
        }
    ...
    def _handle_branch(self, node: Node, parent_node: CfgNode) -> CfgNode:
        ...
        # Parser returns the merge node (exit of the branch)
    ...
    def process_expression(self, node: Node, parent_node: CfgNode) -> CfgNode:
        ...
        if expression_type in self.BASIC_BLOCK_NODES:
            ...
            return branch_exit  # ← Return the merge!
